...
INPUT_DIR = "image-testing/pulp_test"
OUTPUT_DIR = "test_predictions"
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "pulp_test_predictions.csv")
...
def main() -> None:
    ...
    print(f"Accuracy on pulp_test: {correct}/{len(rows)} ({accuracy:.1f}%)")
    print(
        "Note: prob_positive = P(pulp) for this 3-class model "
        "(dentin / enamel / pulp)."
    )
